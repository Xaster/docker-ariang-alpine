...
RUN apk upgrade --no-cache \
    ...
    && wget -O /etc/aria2_default/aria2.conf https://raw.githubusercontent.com/Xaster/docker-ariang-alpine/master/aria2.conf \
    && wget -O /usr/bin/CMD-Shell https://raw.githubusercontent.com/Xaster/docker-ariang-alpine/master/CMD-Shell \
